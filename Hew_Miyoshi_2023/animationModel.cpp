...
void AnimationModel::Draw()
{
	...
	//レジスタ10番にセット
	Renderer::GetDeviceContext()->VSSetConstantBuffers(10, 1, &m_BoneCombMtxCBuffer);
...
void AnimationModel::Update(
	const char *AnimationName1, int Frame1, 
	...
	float BlendRate)
{
	...
	aiAnimation* animation1 = 
		m_Animation[AnimationName1]->mAnimations[0];
	aiAnimation* animation2 = 
		m_Animation[AnimationName2]->mAnimations[0];
